...
class C {
    companion object {
        ...
        const val NOTIFICATION_ACTION_WP = "ee.taltech.spormapsapp.wp"
        const val NOTIFICATION_ACTION_CP = "ee.taltech.spormapsapp.cp"

        const val SESSION_START_FAILED = "ee.taltech.spormapsapp.session_failed"
        const val SESSION_START_ACTION = "ee.taltech.spormapsapp.session_start"
        ...
        const val LOCATION_UPDATE_ACTION_CP = "ee.taltech.spormapsapp.location_update.cp"
